...
*ContactsApi* | [**createHousehold**](docs/Api/ContactsApi.md#createhousehold) | **POST** /crm/api/v1/households | Create a household (EXPERIMENTAL)
*ContactsApi* | [**getByUuid**](docs/Api/ContactsApi.md#getbyuuid) | **GET** /crm/api/v1/contacts/{contactUuid} | Get contact by Uuid
*ContactsApi* | [**getHouseholdByUuid**](docs/Api/ContactsApi.md#gethouseholdbyuuid) | **GET** /crm/api/v1/households/{householdUuid} | Gets a household by uuid (EXPERIMENTAL)
...
*DatabasesApi* | [**deleteDatabase**](docs/Api/DatabasesApi.md#deletedatabase) | **DELETE** /crm/api/v1/databases/{databaseUuid} | Delete a database
...
*GatewaysApi* | [**gatewayAdminLogin**](docs/Api/GatewaysApi.md#gatewayadminlogin) | **POST** /crm/api/v1/gateways/credentials-validation/admin-credentials/login | Verify gateway admin login
...
*GatewaysApi* | [**listGatewayConfigurations**](docs/Api/GatewaysApi.md#listgatewayconfigurations) | **GET** /crm/api/v1/gateways/generic/{gatewayType}/configuration | 
...
*InvestmentApi* | [**getAsset**](docs/Api/InvestmentApi.md#getasset) | **GET** /crm/api/v1/investmentAssets/{id} | Get asset
*InvestmentApi* | [**getInvestment**](docs/Api/InvestmentApi.md#getinvestment) | **GET** /crm/api/v1/investmentAccounts/{id} | Get investment
*InvestmentApi* | [**listInvestmentAssets**](docs/Api/InvestmentApi.md#listinvestmentassets) | **GET** /crm/api/v1/investmentAccounts/{id}/assets | List investment assets
...
- [ContactsBooleanCreateCustomFieldPayload](docs/Model/ContactsBooleanCreateCustomFieldPayload.md)
- [ContactsBooleanCustomField](docs/Model/ContactsBooleanCustomField.md)
...
- [ContactsContactRelation](docs/Model/ContactsContactRelation.md)
- [ContactsContactRelationParticipant](docs/Model/ContactsContactRelationParticipant.md)
...
- [ContactsCreateCustomFieldPayload](docs/Model/ContactsCreateCustomFieldPayload.md)
...
- [ContactsCustomFieldTypeSchema](docs/Model/ContactsCustomFieldTypeSchema.md)
- [ContactsDateCreateCustomFieldPayload](docs/Model/ContactsDateCreateCustomFieldPayload.md)
- [ContactsDateCustomField](docs/Model/ContactsDateCustomField.md)
- [ContactsEmail](docs/Model/ContactsEmail.md)
- [ContactsFieldValueCreateCustomFieldPayload](docs/Model/ContactsFieldValueCreateCustomFieldPayload.md)
...
- [ContactsInvestorProfile](docs/Model/ContactsInvestorProfile.md)
- [ContactsListContactResponse](docs/Model/ContactsListContactResponse.md)
- [ContactsMoneyCreateCustomFieldPayload](docs/Model/ContactsMoneyCreateCustomFieldPayload.md)
- [ContactsMoneyCustomField](docs/Model/ContactsMoneyCustomField.md)
- [ContactsNumericCreateCustomFieldPayload](docs/Model/ContactsNumericCreateCustomFieldPayload.md)
- [ContactsNumericCustomField](docs/Model/ContactsNumericCustomField.md)
...
- [ContactsRiskTolerance](docs/Model/ContactsRiskTolerance.md)
- [ContactsSegmentation](docs/Model/ContactsSegmentation.md)
- [ContactsTextCreateCustomFieldPayload](docs/Model/ContactsTextCreateCustomFieldPayload.md)
- [ContactsTextCustomField](docs/Model/ContactsTextCustomField.md)
...
- [InvestmentsCannexCompany](docs/Model/InvestmentsCannexCompany.md)
- [InvestmentsCannexDistribution](docs/Model/InvestmentsCannexDistribution.md)
- [InvestmentsCannexExchange](docs/Model/InvestmentsCannexExchange.md)
- [InvestmentsCannexFund](docs/Model/InvestmentsCannexFund.md)
- [InvestmentsCannexInformation](docs/Model/InvestmentsCannexInformation.md)
