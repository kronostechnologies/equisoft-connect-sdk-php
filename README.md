...
*MovementApi* | [**getExecutedMovementInfo**](docs/Api/MovementApi.md#getexecutedmovementinfo) | **GET** /crm/api/v1/movements/executed/{executedMovementId} | Get basic information about an executed movement
