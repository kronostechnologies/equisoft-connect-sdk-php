...
*MovementApi* | [**getExecutedMovementInfo**](docs/Api/MovementApi.md#getexecutedmovementinfo) | **GET** /movements/executed/{executedMovementId} | Get basic information about an executed movement
