...
| [**getExecutedMovementInfo()**](MovementApi.md#getExecutedMovementInfo) | **GET** /movements/executed/{executedMovementId} | Get basic information about an executed movement |
