...
```php
legacyProvisioningActivateUser($userId): \Equisoft\SDK\EquisoftConnect\Model\LegacyResponse
```
...
try {
    $result = $apiInstance->legacyProvisioningActivateUser($userId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningActivateUser: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
legacyProvisioningCloseUserSession($userId): \Equisoft\SDK\EquisoftConnect\Model\LegacyResponse
```
...
try {
    $result = $apiInstance->legacyProvisioningCloseUserSession($userId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningCloseUserSession: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
legacyProvisioningDeactivateUser($userId): \Equisoft\SDK\EquisoftConnect\Model\LegacyResponse
```
...
try {
    $result = $apiInstance->legacyProvisioningDeactivateUser($userId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningDeactivateUser: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
legacyProvisioningGetLoginLog($legacyProvisioningLoginLogOptionsRequest): \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningLoginLogResponse
```
...
$legacyProvisioningLoginLogOptionsRequest = new \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningLoginLogOptionsRequest(); // \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningLoginLogOptionsRequest

try {
    $result = $apiInstance->legacyProvisioningGetLoginLog($legacyProvisioningLoginLogOptionsRequest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningGetLoginLog: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningLoginLogResponse**](../Model/LegacyProvisioningLoginLogResponse.md)
...
```php
legacyProvisioningGetMoveUserToOrganizationStatus($moveId): \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningGetMoveUserToOrganizationStatus
```
...
$moveId = 'moveId_example'; // string | Move request unique identifier.

try {
    $result = $apiInstance->legacyProvisioningGetMoveUserToOrganizationStatus($moveId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningGetMoveUserToOrganizationStatus: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningGetMoveUserToOrganizationStatus**](../Model/LegacyProvisioningGetMoveUserToOrganizationStatus.md)
...
```php
legacyProvisioningGetOrganization($orgId): \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningGetOrganizationResponse
```
...
try {
    $result = $apiInstance->legacyProvisioningGetOrganization($orgId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningGetOrganization: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
legacyProvisioningGetOrganizationList(): \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningGetOrganizationListResponse
```
...
try {
    $result = $apiInstance->legacyProvisioningGetOrganizationList();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningGetOrganizationList: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
legacyProvisioningGetUser($userId): \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningGetUserResponse
```
...
try {
    $result = $apiInstance->legacyProvisioningGetUser($userId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningGetUser: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningGetUserResponse**](../Model/LegacyProvisioningGetUserResponse.md)
...
```php
legacyProvisioningGetUserList($legacyProvisioningUserListOptionsRequest): \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningResponseGetUserListResponse
```
...
$legacyProvisioningUserListOptionsRequest = new \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningUserListOptionsRequest(); // \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningUserListOptionsRequest

try {
    $result = $apiInstance->legacyProvisioningGetUserList($legacyProvisioningUserListOptionsRequest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningGetUserList: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningResponseGetUserListResponse**](../Model/LegacyProvisioningResponseGetUserListResponse.md)
...
```php
legacyProvisioningMoveUserToOrganization($userId, $toOrgId): \Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningMoveUserToOrganizationResponse
```
...
$userId = 'userId_example'; // string | User identifier.
$toOrgId = 'toOrgId_example'; // string | Unique identifier of the target organization.

try {
    $result = $apiInstance->legacyProvisioningMoveUserToOrganization($userId, $toOrgId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningMoveUserToOrganization: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningMoveUserToOrganizationResponse**](../Model/LegacyProvisioningMoveUserToOrganizationResponse.md)
...
```php
legacyProvisioningUnlockUser($userId): \Equisoft\SDK\EquisoftConnect\Model\LegacyResponse
```
...
try {
    $result = $apiInstance->legacyProvisioningUnlockUser($userId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LegacyProvisioningApi->legacyProvisioningUnlockUser: ', $e->getMessage(), PHP_EOL;
}
```
