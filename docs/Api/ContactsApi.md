...
| [**createHousehold()**](ContactsApi.md#createHousehold) | **POST** /crm/api/v1/households | Create a household (EXPERIMENTAL) |
| [**getByUuid()**](ContactsApi.md#getByUuid) | **GET** /crm/api/v1/contacts/{contactUuid} | Get contact by Uuid |
| [**getHouseholdByUuid()**](ContactsApi.md#getHouseholdByUuid) | **GET** /crm/api/v1/households/{householdUuid} | Gets a household by uuid (EXPERIMENTAL) |
