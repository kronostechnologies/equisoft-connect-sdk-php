...
class LegacyProvisioningApi
{
     ...
     *
     * @param  LegacyProvisioningGatewayArchivePayload $payload Legacy payload argument. (required)
     ...
     *
     * @param  LegacyProvisioningWebuserDatabasePayload $payload Legacy payload argument. (required)
     ...
     */
    public function legacyProvisioningGetWebuserDatabaseListByValue($payload, string $contentType = self::contentTypes['legacyProvisioningGetWebuserDatabaseListByValue'][0])
    {
        list($response) = $this->legacyProvisioningGetWebuserDatabaseListByValueWithHttpInfo($payload, $contentType);
        return $response;
    }
     ...
     */
    public function legacyProvisioningGetWebuserDatabaseListByValueWithHttpInfo($payload, string $contentType = self::contentTypes['legacyProvisioningGetWebuserDatabaseListByValue'][0])
    {
        $request = $this->legacyProvisioningGetWebuserDatabaseListByValueRequest($payload, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function legacyProvisioningGetWebuserDatabaseListByValueAsync($payload, string $contentType = self::contentTypes['legacyProvisioningGetWebuserDatabaseListByValue'][0])
    {
        return $this->legacyProvisioningGetWebuserDatabaseListByValueAsyncWithHttpInfo($payload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function legacyProvisioningGetWebuserDatabaseListByValueAsyncWithHttpInfo($payload, string $contentType = self::contentTypes['legacyProvisioningGetWebuserDatabaseListByValue'][0])
    {
        $returnType = '\Equisoft\SDK\EquisoftConnect\Model\LegacyProvisioningGetWebuserDatabaseListByValueResponse';
        $request = $this->legacyProvisioningGetWebuserDatabaseListByValueRequest($payload, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function legacyProvisioningGetWebuserDatabaseListByValueRequest($payload, string $contentType = self::contentTypes['legacyProvisioningGetWebuserDatabaseListByValue'][0])
    {

        // verify the required parameter 'payload' is set
        if ($payload === null || (is_array($payload) && count($payload) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payload when calling legacyProvisioningGetWebuserDatabaseListByValue'
            );
        }
