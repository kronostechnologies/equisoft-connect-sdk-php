...
class LegacyProvisioningApi
{
    ...
    /**
     * Operation appsProvisioningPost
     *
    ...
    {
        list($response) = $this->appsProvisioningPostWithHttpInfo($method, $json, $body);
        return $response;
    }

    /**
     * Operation appsProvisioningPostWithHttpInfo
     *
     * Legacy API entrypoint
     *
     * @param  string $method Legacy method name (required)
    ...
    /**
     * Operation appsProvisioningPostAsync
     *
     * Legacy API entrypoint
     *
     * @param  string $method Legacy method name (required)
     ...
     */
    public function appsProvisioningPostAsync($method, $json = null, $body = null)
    {
        return $this->appsProvisioningPostAsyncWithHttpInfo($method, $json, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation appsProvisioningPostAsyncWithHttpInfo
     *
     * Legacy API entrypoint
     *
     * @param  string $method Legacy method name (required)
    ...
    /**
     * Create request for operation 'appsProvisioningPost'
     *
     * @param  string $method Legacy method name (required)
     * @param  bool $json (optional)
     * @param  AnyType $body (optional)
     ...
     */
    protected function appsProvisioningPostRequest($method, $json = null, $body = null)
    {
        // verify the required parameter 'method' is set
        if ($method === null || (is_array($method) && count($method) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $method when calling appsProvisioningPost'
            );
        }

        $resourcePath = '/apps/provisioning/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrganizationRequest($orgId)
    {
     ...
     * @throws \Equisoft\SDK\EquisoftConnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Equisoft\SDK\EquisoftConnect\Model\LegacyResponse|\Equisoft\SDK\EquisoftConnect\Model\LegacyResponse|\Equisoft\SDK\EquisoftConnect\Model\LegacyResponse
     */
     ...
     * @throws \Equisoft\SDK\EquisoftConnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Equisoft\SDK\EquisoftConnect\Model\LegacyResponse|\Equisoft\SDK\EquisoftConnect\Model\LegacyResponse|\Equisoft\SDK\EquisoftConnect\Model\LegacyResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrganizationListRequest()
    {
