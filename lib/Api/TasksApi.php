    ...
    public function listTasksRequest($ownerId = null, $contactIds = null, $minDueDate = null, $maxDueDate = null, $isCompleted = null, $dueDateFilter = null, $orderBy = null, $pageToken = null, $maxResults = null, $acceptLanguage = null)
    {
        ...
        if ($minDueDate !== null) {
            if('form' === 'form' && is_array($minDueDate)) {
                ...
                $queryParams['minDueDate'] = ObjectSerializer::toString($minDueDate);
            }
        }
        // query params
        if ($maxDueDate !== null) {
            if('form' === 'form' && is_array($maxDueDate)) {
                ...
                $queryParams['maxDueDate'] = ObjectSerializer::toString($maxDueDate);
            }
        }
        // query params
        if ($isCompleted !== null) {
        ...
        if ($dueDateFilter !== null) {
            if('form' === 'form' && is_array($dueDateFilter)) {
                ...
                $queryParams['dueDateFilter'] = ObjectSerializer::toString($dueDateFilter);
            }
        }
        // query params
        if ($orderBy !== null) {
