...
class ContactsApi
{
     ...
     */
    public function getByUuid($contactUuid, $acceptLanguage = null)
    {
        list($response) = $this->getByUuidWithHttpInfo($contactUuid, $acceptLanguage);
        return $response;
    }
     ...
     */
    public function getByUuidWithHttpInfo($contactUuid, $acceptLanguage = null)
    {
        $request = $this->getByUuidRequest($contactUuid, $acceptLanguage);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Equisoft\SDK\EquisoftConnect\Model\ContactsContact' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Equisoft\SDK\EquisoftConnect\Model\ContactsContact' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Equisoft\SDK\EquisoftConnect\Model\ContactsContact', []),
     ...
     */
    public function getByUuidAsync($contactUuid, $acceptLanguage = null)
    {
        return $this->getByUuidAsyncWithHttpInfo($contactUuid, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByUuidAsyncWithHttpInfo($contactUuid, $acceptLanguage = null)
    {
        $returnType = '\Equisoft\SDK\EquisoftConnect\Model\ContactsContact';
        $request = $this->getByUuidRequest($contactUuid, $acceptLanguage);
     ...
     */
    public function getByUuidRequest($contactUuid, $acceptLanguage = null)
    {
     ...
     */
    public function patchContact($contactUuid, $contactPatchContactPayload)
    {
        list($response) = $this->patchContactWithHttpInfo($contactUuid, $contactPatchContactPayload);
        return $response;
    }
     ...
     */
    public function patchContactWithHttpInfo($contactUuid, $contactPatchContactPayload)
    {
        $request = $this->patchContactRequest($contactUuid, $contactPatchContactPayload);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchContactAsync($contactUuid, $contactPatchContactPayload)
    {
        return $this->patchContactAsyncWithHttpInfo($contactUuid, $contactPatchContactPayload)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchContactAsyncWithHttpInfo($contactUuid, $contactPatchContactPayload)
    {
        $returnType = '\Equisoft\SDK\EquisoftConnect\Model\ContactsContact';
        $request = $this->patchContactRequest($contactUuid, $contactPatchContactPayload);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchContactRequest($contactUuid, $contactPatchContactPayload)
    {
        // verify the required parameter 'contactUuid' is set
        if ($contactUuid === null || (is_array($contactUuid) && count($contactUuid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($contactPatchContactPayload)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($contactPatchContactPayload));
            } else {
