...
class ContactsApi
{
     ...
     * @return \Equisoft\SDK\EquisoftConnect\Model\ContactsTemporaryContact|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse
     */
    public function createContact($contactsCreateContactPayload, string $contentType = self::contentTypes['createContact'][0])
    {
     ...
     * @throws \Equisoft\SDK\EquisoftConnect\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Equisoft\SDK\EquisoftConnect\Model\ContactsTemporaryContact|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContactWithHttpInfo($contactsCreateContactPayload, string $contentType = self::contentTypes['createContact'][0])
    {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Equisoft\SDK\EquisoftConnect\Model\ContactsTemporaryContact',
                        $request,
                        $response,
                    );
                case 401:
     ...
     */
    public function createContactAsync($contactsCreateContactPayload, string $contentType = self::contentTypes['createContact'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createContactAsyncWithHttpInfo($contactsCreateContactPayload, string $contentType = self::contentTypes['createContact'][0])
    {
        $returnType = '\Equisoft\SDK\EquisoftConnect\Model\ContactsTemporaryContact';
        $request = $this->createContactRequest($contactsCreateContactPayload, $contentType);
     ...
     */
    public function createContactRequest($contactsCreateContactPayload, string $contentType = self::contentTypes['createContact'][0])
    {
     ...
     * @throws \Equisoft\SDK\EquisoftConnect\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Equisoft\SDK\EquisoftConnect\Model\DocumentsListDocumentResponse|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse
     */
    public function listContactDocument($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactDocument'][0])
    {
     ...
     */
    public function listContactDocumentWithHttpInfo($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactDocument'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listContactDocumentAsync($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactDocument'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listContactDocumentAsyncWithHttpInfo($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactDocument'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listContactDocumentRequest($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactDocument'][0])
    {
     ...
     * @throws \Equisoft\SDK\EquisoftConnect\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Equisoft\SDK\EquisoftConnect\Model\InvestmentsListAccountResponse|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse
     */
    public function listContactInvestment($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactInvestment'][0])
    {
     ...
     */
    public function listContactInvestmentWithHttpInfo($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactInvestment'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listContactInvestmentAsync($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactInvestment'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listContactInvestmentAsyncWithHttpInfo($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactInvestment'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listContactInvestmentRequest($contactUuid, $pageToken = null, $maxResults = null, string $contentType = self::contentTypes['listContactInvestment'][0])
    {
