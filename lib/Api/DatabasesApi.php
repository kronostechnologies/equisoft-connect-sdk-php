...
class DatabasesApi
{
     ...
     * @return void
     */
    public function updateState($databaseUuid, $databaseUpdateStatePayload)
    {
        $this->updateStateWithHttpInfo($databaseUuid, $databaseUpdateStatePayload);
    }
     ...
     */
    public function updateStateWithHttpInfo($databaseUuid, $databaseUpdateStatePayload)
    {
        $request = $this->updateStateRequest($databaseUuid, $databaseUpdateStatePayload);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStateAsync($databaseUuid, $databaseUpdateStatePayload)
    {
        return $this->updateStateAsyncWithHttpInfo($databaseUuid, $databaseUpdateStatePayload)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStateAsyncWithHttpInfo($databaseUuid, $databaseUpdateStatePayload)
    {
        $returnType = '';
        $request = $this->updateStateRequest($databaseUuid, $databaseUpdateStatePayload);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateStateRequest($databaseUuid, $databaseUpdateStatePayload)
    {
        // verify the required parameter 'databaseUuid' is set
        if ($databaseUuid === null || (is_array($databaseUuid) && count($databaseUuid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($databaseUpdateStatePayload)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($databaseUpdateStatePayload));
            } else {
