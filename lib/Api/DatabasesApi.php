...
class DatabasesApi
{
    ...
    public function createChargebeeCustomerWithHttpInfo($databaseUuid, string $contentType = self::contentTypes['createChargebeeCustomer'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Equisoft\SDK\EquisoftConnect\Model\DatabaseDatabaseChargebeeCustomerCreatedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Equisoft\SDK\EquisoftConnect\Model\DatabaseDatabaseChargebeeCustomerCreatedResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Equisoft\SDK\EquisoftConnect\Model\DatabaseDatabaseChargebeeCustomerCreatedResponse', []),
