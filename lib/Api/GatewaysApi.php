    ...
    public function listEquisoftAnalyzeAccessesRequest($userUuid = null)
    {
        ...
        if ($userUuid !== null) {
            if('form' === 'form' && is_array($userUuid)) {
                ...
                $queryParams['userUuid'] = ObjectSerializer::toString($userUuid);
            }
        }
    ...
    public function listGenericCredentialsRequest($gatewayName, $includeSsn = null)
    {
        ...
        if ($includeSsn !== null) {
            if('form' === 'form' && is_array($includeSsn)) {
                ...
                $queryParams['includeSsn'] = ObjectSerializer::toString($includeSsn);
            }
        }
    ...
    public function updateCredentialsRequest($gatewayId, $status, $authorization, $credentialIds = null)
    {
        ...
        if ($credentialIds !== null) {
            if('form' === 'form' && is_array($credentialIds)) {
                ...
                $queryParams['credentialIds'] = ObjectSerializer::toString($credentialIds);
            }
        }
