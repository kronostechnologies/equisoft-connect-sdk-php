    ...
    public function getEventInstancesRequest($eventId, $minTime = null, $maxTime = null, $pageToken = null, $maxResults = null, $acceptLanguage = null)
    {
        ...
        if ($minTime !== null) {
            if('form' === 'form' && is_array($minTime)) {
                ...
                $queryParams['minTime'] = ObjectSerializer::toString($minTime);
            }
        }
        // query params
        if ($maxTime !== null) {
            if('form' === 'form' && is_array($maxTime)) {
                ...
                $queryParams['maxTime'] = ObjectSerializer::toString($maxTime);
            }
        }
        // query params
        if ($pageToken !== null) {
        ...
        if ($maxResults !== null) {
            if('form' === 'form' && is_array($maxResults)) {
                ...
                $queryParams['maxResults'] = ObjectSerializer::toString($maxResults);
            }
        }
    ...
    public function getEventInternalNoteListRequest($eventId, $history = null, $acceptLanguage = null)
    {
        ...
        if ($history !== null) {
            if('form' === 'form' && is_array($history)) {
                ...
                $queryParams['history'] = ObjectSerializer::toString($history);
            }
        }
    ...
    public function listEventsRequest($calendarId = null, $ownerId = null, $contactIds = null, $minTime = null, $maxTime = null, $singleEvents = null, $isCompleted = null, $orderBy = null, $pageToken = null, $maxResults = null, $acceptLanguage = null)
    {
        ...
        if ($calendarId !== null) {
            if('form' === 'form' && is_array($calendarId)) {
                ...
                $queryParams['calendarId'] = ObjectSerializer::toString($calendarId);
            }
        }
        // query params
        if ($ownerId !== null) {
            if('form' === 'form' && is_array($ownerId)) {
                ...
                $queryParams['ownerId'] = ObjectSerializer::toString($ownerId);
            }
        }
        // query params
        if ($contactIds !== null) {
            if('form' === 'form' && is_array($contactIds)) {
                ...
                $queryParams['contactIds'] = ObjectSerializer::toString($contactIds);
            }
        }
        // query params
        if ($minTime !== null) {
        ...
        if ($singleEvents !== null) {
            if('form' === 'form' && is_array($singleEvents)) {
                ...
                $queryParams['singleEvents'] = ObjectSerializer::toString($singleEvents);
            }
        }
        // query params
        if ($isCompleted !== null) {
            if('form' === 'form' && is_array($isCompleted)) {
                ...
                $queryParams['isCompleted'] = ObjectSerializer::toString($isCompleted);
            }
        }
        // query params
        if ($orderBy !== null) {
            if('form' === 'form' && is_array($orderBy)) {
                ...
                $queryParams['orderBy'] = ObjectSerializer::toString($orderBy);
            }
        }
        // query params
        if ($pageToken !== null) {
