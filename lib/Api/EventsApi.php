...
class EventsApi
{
    ...
    {
        list($response) = $this->archiveEventInternalNoteWithHttpInfo($eventId, $noteId, $acceptLanguage);
        return $response;
    }
    ...
    {
        list($response) = $this->restoreEventInternalNoteWithHttpInfo($eventId, $noteId, $acceptLanguage);
        return $response;
    }
