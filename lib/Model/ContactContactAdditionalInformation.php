...
class ContactContactAdditionalInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'twitterLink' => 'string',
        'linkedInLink' => 'string',
        'language' => '\Equisoft\SDK\EquisoftConnect\Model\ContactContactAdditionalInformationLanguage',
        'pictureId' => 'int'
    ];
    ...
    */
     ...
     * Sets language
     *
     * @param \Equisoft\SDK\EquisoftConnect\Model\ContactContactAdditionalInformationLanguage|null $language language
     *
     * @return self
     */
