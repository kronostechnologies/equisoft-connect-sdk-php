...
/**
 * DsfFinancialCenterPayload Class Doc Comment
 *
 * @category Class
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 ...
 */
class DsfFinancialCenterPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dsf.FinancialCenterPayload';
    ...
    {
        $this->setIfExists('nameFr', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($nameFr)) {
            throw new \InvalidArgumentException('non-nullable nameFr cannot be null');
        }
