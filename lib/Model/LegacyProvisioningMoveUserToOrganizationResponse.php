...
/**
 * LegacyProvisioningMoveUserToOrganizationResponse Class Doc Comment
 *
 * @category Class
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 ...
 */
class LegacyProvisioningMoveUserToOrganizationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'legacy.provisioning.MoveUserToOrganizationResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('moveId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['moveId'];
    }

    /**
     * Sets moveId
     *
     * @param string|null $moveId Move request unique identifier, required to call GetMoveUserToAgencyStatus.
     *
     * @return self
     */
    ...
    {
        if (is_null($moveId)) {
            throw new \InvalidArgumentException('non-nullable moveId cannot be null');
        }
        $this->container['moveId'] = $moveId;
