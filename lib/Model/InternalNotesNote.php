...
class InternalNotesNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['firstRevisionCreatedAt'] === null && !$this->isNullableSetToNull('firstRevisionCreatedAt')) {
        ...
        if ($this->container['currentRevision'] === null && !$this->isNullableSetToNull('currentRevision')) {
