...
class LegacyDocumentDocumentGetListPayloadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('optionsPayload', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($optionsPayload)) {
            throw new \InvalidArgumentException('non-nullable optionsPayload cannot be null');
        }
