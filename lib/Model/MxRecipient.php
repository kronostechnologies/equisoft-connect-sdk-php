...
class MxRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mx.recipient';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['screenName'] === null) {
            $invalidProperties[] = "'screenName' can't be null";
        }
