...
/**
 * ContactContactMaritalStatusStatus Class Doc Comment
 *
 * @category Class
 * @description Marital status current status
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ContactContactMaritalStatusStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contact_ContactMaritalStatus_status';
