...
class DatabasesApi
{
     ...
     *
     * @param  \Equisoft\SDK\EquisoftConnect\Model\DatabasesCreateDatabasePayload $databasesCreateDatabasePayload databasesCreateDatabasePayload (required)
     ...
     * @return \Equisoft\SDK\EquisoftConnect\Model\DatabasesDatabase|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse|null
     */
    public function createDatabase(
        \Equisoft\SDK\EquisoftConnect\Model\DatabasesCreateDatabasePayload $databasesCreateDatabasePayload,
        string $contentType = self::contentTypes['createDatabase'][0]
    ): \Equisoft\SDK\EquisoftConnect\Model\DatabasesDatabase|\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse|null
    {
        list($response) = $this->createDatabaseWithHttpInfo($databasesCreateDatabasePayload, $contentType);
        return $response;
    }
     ...
     * Create database for an organization
     *
     * @param  \Equisoft\SDK\EquisoftConnect\Model\DatabasesCreateDatabasePayload $databasesCreateDatabasePayload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDatabase'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     ...
     */
    public function createDatabaseWithHttpInfo(
        \Equisoft\SDK\EquisoftConnect\Model\DatabasesCreateDatabasePayload $databasesCreateDatabasePayload,
        string $contentType = self::contentTypes['createDatabase'][0]
    ): array
    {
        $request = $this->createDatabaseRequest($databasesCreateDatabasePayload, $contentType);
     ...
     */
    public function createDatabaseAsync(
        \Equisoft\SDK\EquisoftConnect\Model\DatabasesCreateDatabasePayload $databasesCreateDatabasePayload,
        string $contentType = self::contentTypes['createDatabase'][0]
    ): PromiseInterface
    {
        return $this->createDatabaseAsyncWithHttpInfo($databasesCreateDatabasePayload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function createDatabaseAsyncWithHttpInfo(
        \Equisoft\SDK\EquisoftConnect\Model\DatabasesCreateDatabasePayload $databasesCreateDatabasePayload,
        string $contentType = self::contentTypes['createDatabase'][0]
    ): PromiseInterface
    {
    ...
    ): Request
    {
        ...
        // verify the required parameter 'databasesCreateDatabasePayload' is set
        if ($databasesCreateDatabasePayload === null || (is_array($databasesCreateDatabasePayload) && count($databasesCreateDatabasePayload) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $databasesCreateDatabasePayload when calling createDatabase'
            );
        }
        ...
        // for model (json/xml)
        if (isset($databasesCreateDatabasePayload)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($databasesCreateDatabasePayload));
            } else {
                $httpBody = $databasesCreateDatabasePayload;
            }
     ...
     * @param  \Equisoft\SDK\EquisoftConnect\Model\UsersDeleteUserPayload $usersDeleteUserPayload usersDeleteUserPayload (required)
    ...
    public function deleteUser(
        string $databaseUuid,
        string $userUuid,
        \Equisoft\SDK\EquisoftConnect\Model\UsersDeleteUserPayload $usersDeleteUserPayload,
        string $contentType = self::contentTypes['deleteUser'][0]
    ): ?\Equisoft\SDK\EquisoftConnect\Model\ErrorResponse
    {
        list($response) = $this->deleteUserWithHttpInfo($databaseUuid, $userUuid, $usersDeleteUserPayload, $contentType);
        return $response;
    }
     ...
     * @param  string $databaseUuid Database unique identifier. (required)
     * @param  string $userUuid User uuid. (required)
     * @param  \Equisoft\SDK\EquisoftConnect\Model\UsersDeleteUserPayload $usersDeleteUserPayload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteUser'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
    ...
    {
        $request = $this->deleteUserRequest($databaseUuid, $userUuid, $usersDeleteUserPayload, $contentType);
    ...
    {
        return $this->deleteUserAsyncWithHttpInfo($databaseUuid, $userUuid, $usersDeleteUserPayload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($databaseUuid === null || (is_array($databaseUuid) && count($databaseUuid) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $databaseUuid when calling deleteUser'
            );
        }
        ...
        if ($userUuid === null || (is_array($userUuid) && count($userUuid) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $userUuid when calling deleteUser'
            );
        }

        // verify the required parameter 'usersDeleteUserPayload' is set
        if ($usersDeleteUserPayload === null || (is_array($usersDeleteUserPayload) && count($usersDeleteUserPayload) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $usersDeleteUserPayload when calling deleteUser'
            );
        }


        $resourcePath = '/crm/api/v1/databases/{databaseUuid}/users/{userUuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($usersDeleteUserPayload)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($usersDeleteUserPayload));
            } else {
                $httpBody = $usersDeleteUserPayload;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
