...
class ContextPreferences implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'context.preferences';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('timeFormat', $data ?? [], null);
        $this->setIfExists('firstDayOfWeek', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTimeFormat(string $timeFormat): static
    {
        if (is_null($timeFormat)) {
            throw new InvalidArgumentException('non-nullable timeFormat cannot be null');
        }
    ...
    public function setFirstDayOfWeek(string $firstDayOfWeek): static
    {
        if (is_null($firstDayOfWeek)) {
            throw new InvalidArgumentException('non-nullable firstDayOfWeek cannot be null');
        }
