...
class MovementUserMap implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'movement.UserMap';
    ...
    */
     ...
     * @return $this
     */
    public function setSrcEmail(?string $srcEmail): static
    {
        if (is_null($srcEmail)) {
     ...
     * @return string|null
     */
    public function getDstEmail(): ?string
    {
     ...
     * @return $this
     */
    public function setDstEmail(?string $dstEmail): static
    {
        if (is_null($dstEmail)) {
