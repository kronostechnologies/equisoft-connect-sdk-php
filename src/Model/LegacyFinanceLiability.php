...
class LegacyFinanceLiability implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.finance.Liability';
    ...
    */
     ...
     * @return float|null
     */
    public function getPctOwnership(): ?float
    {
     ...
     * @return $this
     */
    public function setPctOwnership(?float $pctOwnership): static
    {
     ...
     * @return $this
     */
    public function setInstalment(?float $instalment): static
    {
     ...
     * @return string|null
     */
    public function getInstalmentFrequency(): ?string
    {
     ...
     * @return $this
     */
    public function setInstalmentFrequency(?string $instalmentFrequency): static
    {
