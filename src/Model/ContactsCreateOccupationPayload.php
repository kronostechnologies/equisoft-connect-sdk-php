<?php
/**
 * ContactsCreateOccupationPayload
 *
 * PHP version 8.1
 *
...
/**
 * ContactsCreateOccupationPayload Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactsCreateOccupationPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contacts.CreateOccupationPayload';
    ...
    */
    ...
    {
        if (is_null($employer)) {
            array_push($this->openAPINullablesSetToNull, 'employer');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('employer', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return $this
     */
    public function setAnnualIncome(?float $annualIncome): static
    {
