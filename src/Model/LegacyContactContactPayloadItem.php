...
class LegacyContactContactPayloadItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.contact.ContactPayloadItem';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('externalKeyType', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getExternalKeyType(): ?string
    {
     ...
     * @return $this
     */
    public function setExternalKeyType(?string $externalKeyType): static
    {
        if (is_null($externalKeyType)) {
            throw new InvalidArgumentException('non-nullable externalKeyType cannot be null');
        }
