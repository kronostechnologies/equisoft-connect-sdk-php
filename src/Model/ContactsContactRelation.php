...
class ContactsContactRelation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contacts.ContactRelation';
    ...
    */
     ...
     */
    public function getLinkType(): ?\Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue
    {
     ...
     * Sets linkType
     *
     * @param \Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue|null $linkType linkType
     *
     * @return $this
     */
    public function setLinkType(?\Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue $linkType): static
    {
        if (is_null($linkType)) {
