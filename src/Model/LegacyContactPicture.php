...
/**
 * LegacyContactPicture Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LegacyContactPicture implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.contact.Picture';
    ...
    */
     ...
     * Sets sizeBytes
     *
     * @param int|null $sizeBytes Size of the file(in bytes).
     *
     * @return $this
     */
     ...
     *
     * @param string|null $base64EncodedData Picture data encoded in base 64.
     *
     * @return $this
     */
    public function setBase64EncodedData(?string $base64EncodedData): static
    {
