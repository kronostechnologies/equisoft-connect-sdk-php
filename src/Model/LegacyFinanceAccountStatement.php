...
class LegacyFinanceAccountStatement implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.finance.AccountStatement';
    ...
    */
     ...
     * @return string|null
     */
    public function getDealers(): ?string
    {
     ...
     * @return $this
     */
    public function setDealers(?string $dealers): static
    {
        if (is_null($dealers)) {
