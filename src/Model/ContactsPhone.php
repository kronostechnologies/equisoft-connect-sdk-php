...
class ContactsPhone implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contacts.Phone';
    ...
    */
     ...
     */
    public function getType(): ?\Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue
    {
     ...
     * @return $this
     */
    public function setType(?\Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue $type): static
    {
        if (is_null($type)) {
