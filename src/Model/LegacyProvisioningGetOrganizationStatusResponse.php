...
/**
 * LegacyProvisioningGetOrganizationStatusResponse Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LegacyProvisioningGetOrganizationStatusResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.provisioning.GetOrganizationStatusResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('orgStatus', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['orgStatus'];
    }

    /**
     * Sets orgStatus
     *
     * @param string|null $orgStatus Status of the organization.
     *
     * @return $this
     */
    public function setOrgStatus(?string $orgStatus): static
    {
        if (is_null($orgStatus)) {
            throw new InvalidArgumentException('non-nullable orgStatus cannot be null');
        }
        $this->container['orgStatus'] = $orgStatus;
