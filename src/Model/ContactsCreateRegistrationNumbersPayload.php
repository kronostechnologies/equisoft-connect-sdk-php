...
/**
 * ContactsCreateRegistrationNumbersPayload Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactsCreateRegistrationNumbersPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contacts.CreateRegistrationNumbersPayload';
    ...
    */
    ...
    public function setIdentificationNumber(?string $identificationNumber): static
    {
        if (is_null($identificationNumber)) {
            array_push($this->openAPINullablesSetToNull, 'identificationNumber');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('identificationNumber', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * @return string|null
     */
    public function getFederalNumber(): ?string
    {
     ...
     * @return $this
     */
    public function setFederalNumber(?string $federalNumber): static
    {
        if (is_null($federalNumber)) {
            array_push($this->openAPINullablesSetToNull, 'federalNumber');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('federalNumber', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return string|null
     */
    public function getProvincialNumber(): ?string
    {
     ...
     * @return $this
     */
    public function setProvincialNumber(?string $provincialNumber): static
    {
        if (is_null($provincialNumber)) {
            array_push($this->openAPINullablesSetToNull, 'provincialNumber');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('provincialNumber', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
