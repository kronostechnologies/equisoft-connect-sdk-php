 ...
 */
class LegacyDocumentDocumentPayloadRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.document.DocumentPayloadRequest';
    ...
    */
     ...
     */
    public function getPayload(): \Equisoft\SDK\EquisoftConnect\Model\LegacyDocumentDocumentPayload
    {
     ...
     * @return $this
     */
    public function setPayload(\Equisoft\SDK\EquisoftConnect\Model\LegacyDocumentDocumentPayload $payload): static
    {
        if (is_null($payload)) {
