...
class UsersUser implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     */
    public function getRole(): \Equisoft\SDK\EquisoftConnect\Model\UsersRole
    {
     ...
     * @return $this
     */
    public function setRole(\Equisoft\SDK\EquisoftConnect\Model\UsersRole $role): static
    {
        if (is_null($role)) {
     ...
     * @return bool|null
     */
    public function getAclDelegationAllowed(): ?bool
    {
     ...
     * @return $this
     */
    public function setAclDelegationAllowed(?bool $aclDelegationAllowed): static
    {
