...
/**
 * InternalNotesNoteRevision Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InternalNotesNoteRevision implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'internalNotes.NoteRevision';
    ...
    */
     ...
     */
    public function getType(): ?\Equisoft\SDK\EquisoftConnect\Model\InternalNotesNoteRevisionType
    {
     ...
     * @return $this
     */
    public function setType(?\Equisoft\SDK\EquisoftConnect\Model\InternalNotesNoteRevisionType $type): static
    {
        if (is_null($type)) {
     ...
     * Sets content
     *
     * @param string|null $content Note content.
     *
     * @return $this
     */
