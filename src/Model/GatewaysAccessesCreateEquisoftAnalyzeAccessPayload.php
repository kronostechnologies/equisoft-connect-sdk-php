...
class GatewaysAccessesCreateEquisoftAnalyzeAccessPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'gateways.accesses.CreateEquisoftAnalyzeAccessPayload';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('billingType', $data ?? [], null);
    }
    ...
    */
     ...
     * @return $this
     */
    public function setBillingType(string $billingType): static
    {
        if (is_null($billingType)) {
            throw new InvalidArgumentException('non-nullable billingType cannot be null');
        }
