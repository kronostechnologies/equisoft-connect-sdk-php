...
class DatabaseDatabaseChargebeeCustomerCreatedResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'database.DatabaseChargebeeCustomerCreatedResponse';
    ...
    */
     ...
     * @return $this
     */
    public function setChargebeeCustomerId(string $chargebeeCustomerId): static
    {
