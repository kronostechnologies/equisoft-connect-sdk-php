...
/**
 * KronosFieldValuesValue Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class KronosFieldValuesValue implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'kronos.fieldValues.Value';
    ...
    protected static array $openAPITypes = [
        ...
        'frenchLabel' => 'string',
        'englishLabel' => 'string',
        'subValues' => '\Equisoft\SDK\EquisoftConnect\Model\LegacyFieldValuesSubValue[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('subValues', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets isDefault
     *
     * @param string|null $isDefault If the value is the default value.
     *
     * @return $this
     */
     ...
     * Sets systemName
     *
     * @param string|null $systemName System name.
     *
     * @return $this
     */
     ...
     * Sets frenchLabel
     *
     * @param string|null $frenchLabel French label.
     *
     * @return $this
     */
    public function setFrenchLabel(?string $frenchLabel): static
    {
     ...
     * Sets englishLabel
     *
     * @param string|null $englishLabel English label.
     *
     * @return $this
     */
    public function setEnglishLabel(?string $englishLabel): static
    {
    ...
    {
        return $this->container['subValues'];
    }

    /**
     * Sets subValues
     *
     * @param \Equisoft\SDK\EquisoftConnect\Model\LegacyFieldValuesSubValue[]|null $subValues Sub values.
     *
     * @return $this
     */
    public function setSubValues(?array $subValues): static
    {
        if (is_null($subValues)) {
            throw new InvalidArgumentException('non-nullable subValues cannot be null');
        }
        $this->container['subValues'] = $subValues;
