 ...
 */
class AdminCredentialPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdminCredentialPayload';
    ...
    */
    ...
    public function setAdminPassword(string $adminPassword): static
    {
        if (is_null($adminPassword)) {
            throw new InvalidArgumentException('non-nullable adminPassword cannot be null');
        }
