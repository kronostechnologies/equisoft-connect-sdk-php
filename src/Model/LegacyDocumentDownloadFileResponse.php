 ...
 */
class LegacyDocumentDownloadFileResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.document.DownloadFileResponse';
