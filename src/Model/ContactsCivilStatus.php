...
class ContactsCivilStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contacts.CivilStatus';
    ...
    */
     ...
     */
    public function getStatus(): ?\Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue
    {
     ...
     * @return $this
     */
    public function setStatus(?\Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue $status): static
    {
        if (is_null($status)) {
     ...
     * @return \Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue|null
     */
    public function getMarriageContract(): ?\Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue
    {
     ...
     * @return $this
     */
    public function setMarriageContract(?\Equisoft\SDK\EquisoftConnect\Model\ContactsContactFieldValue $marriageContract): static
    {
