 ...
 */
class MovementClientBaseUsingFileMovement implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'movement.ClientBaseUsingFileMovement';
