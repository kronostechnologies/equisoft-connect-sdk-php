...
/**
 * EventsGetEventInstancesResponse Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EventsGetEventInstancesResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'events.GetEventInstancesResponse';
    ...
    */
    ...
    public function setNextPageToken(?string $nextPageToken): static
    {
        if (is_null($nextPageToken)) {
            array_push($this->openAPINullablesSetToNull, 'nextPageToken');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('nextPageToken', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets items
     *
     * @return \Equisoft\SDK\EquisoftConnect\Model\EventsEvent[]
     */
