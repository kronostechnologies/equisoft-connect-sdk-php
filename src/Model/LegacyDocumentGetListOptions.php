...
/**
 * LegacyDocumentGetListOptions Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LegacyDocumentGetListOptions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.document.GetListOptions';
    ...
    */
     ...
     * Sets contactId
     *
     * @param int|null $contactId Fetch only document that are related to this contact id.
     *
     * @return $this
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Limit the result to $limit
     *
     * @return $this
     */
     ...
     * Sets systemType
     *
     * @param string|null $systemType Filter by system type.
     *
     * @return $this
     */
    public function setSystemType(?string $systemType): static
    {
        if (is_null($systemType)) {
            throw new InvalidArgumentException('non-nullable systemType cannot be null');
        }
