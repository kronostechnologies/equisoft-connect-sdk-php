...
class LegacyFinanceGetAccountStatementResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'legacy.finance.getAccountStatementResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('accountStatement', $data ?? [], null);
    }
    ...
    */
     ...
     */
    public function getAccountStatement(): \Equisoft\SDK\EquisoftConnect\Model\LegacyFinanceAccountStatement
    {
     ...
     * @return $this
     */
    public function setAccountStatement(\Equisoft\SDK\EquisoftConnect\Model\LegacyFinanceAccountStatement $accountStatement): static
    {
        if (is_null($accountStatement)) {
            throw new InvalidArgumentException('non-nullable accountStatement cannot be null');
        }
