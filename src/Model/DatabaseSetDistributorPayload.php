...
/**
 * DatabaseSetDistributorPayload Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DatabaseSetDistributorPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'database.SetDistributorPayload';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['distributorCode'] === null) {
            $invalidProperties[] = "'distributorCode' can't be null";
        }
    ...
    public function setDistributorCode(string $distributorCode): static
    {
        if (is_null($distributorCode)) {
            throw new InvalidArgumentException('non-nullable distributorCode cannot be null');
        }
