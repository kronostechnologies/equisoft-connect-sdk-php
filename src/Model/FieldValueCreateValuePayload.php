...
/**
 * FieldValueCreateValuePayload Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FieldValueCreateValuePayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'fieldValue.CreateValuePayload';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('isPrivate', $data ?? [], null);
    }
    ...
    */
    ...
    public function setIsPrivate(?bool $isPrivate): static
    {
        if (is_null($isPrivate)) {
            throw new InvalidArgumentException('non-nullable isPrivate cannot be null');
        }
