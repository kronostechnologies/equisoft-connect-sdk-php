...
class KronosFinanceContactListItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'kronos.finance.ContactListItem';
    ...
    */
     ...
     * @return $this
     */
    public function setAdvisorName(?string $advisorName): static
    {
     ...
     * @return $this
     */
    public function setAdvisorEmail(?string $advisorEmail): static
    {
     ...
     * @return string|null
     */
    public function getAdvisorInitials(): ?string
    {
     ...
     * @return $this
     */
    public function setAdvisorInitials(?string $advisorInitials): static
    {
