...
class ContactContactMaritalStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contact.ContactMaritalStatus';
    ...
    */
     ...
     */
    public function getStatus(): ?\Equisoft\SDK\EquisoftConnect\Model\FieldValue
    {
     ...
     * @return $this
     */
    public function setStatus(?\Equisoft\SDK\EquisoftConnect\Model\FieldValue $status): static
    {
        if (is_null($status)) {
     ...
     * @return \Equisoft\SDK\EquisoftConnect\Model\FieldValue|null
     */
    public function getMarriageContract(): ?\Equisoft\SDK\EquisoftConnect\Model\FieldValue
    {
     ...
     * @return $this
     */
    public function setMarriageContract(?\Equisoft\SDK\EquisoftConnect\Model\FieldValue $marriageContract): static
    {
